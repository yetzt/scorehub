...
scoreboard.prototype.setPeriodClock = function(value, fn){
	...
	self.post('<Clock Id="Period"><Time><![CDATA['+parseInt(value,10)+']]></Time></Clock>', fn);
	return this;
};
...
scoreboard.prototype.adjustPeriodClock = function(value, fn){
	...
	setTimeout(function(){
		self.post('<Clock Id="Period"><Time change="true"><![CDATA['+parseInt((value-(value%1000)),10)+']]></Time></Clock>', fn);
	},(value%1000));
	return this;
};
